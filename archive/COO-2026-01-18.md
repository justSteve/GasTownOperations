...
### 1. TMux Controller (`/root/projects/gtOps/daemon/tmux_controller.py`)
...
### 2. VSCode Command Bridge (`/root/projects/gtOps/daemon/vscode-bridge/`)
...
### 3. Bridge Client (`/root/projects/gtOps/daemon/vscode_bridge.py`)
...
| `/root/projects/gtOps/daemon/tmux_controller.py` | TMux automation |
...
Ready to implement:
1. Create `/root/projects/gtOps/daemon/gt-dashboard.sh` - dual-session launcher
