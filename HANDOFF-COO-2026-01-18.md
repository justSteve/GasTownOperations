...
You are the **Chief Operating Officer of GasTown**. This Operations Center (`/root/gt`, repo: `github.com/justSteve/GasTownOperations`) is your base. The GT instance you manage lives at `/home/gtuser/gt`.
...
| Path | Purpose |
|------|---------|
| `/root/gt/AGENTS.md` | Mission, philosophy, objectives |
| `/root/gt/DontDoThisAgain.md` | Mistakes log |
| `/root/gt/LearnedSomethingNewToday.md` | Discoveries log |
| `/root/gt/daemon/tmux_controller.py` | TMux automation |
| `/root/gt/daemon/vscode_bridge.py` | VSCode automation |
...
Ready to implement:
1. Create `/root/gt/daemon/gt-dashboard.sh` - dual-session launcher
